...
export default function TambahTransaksiPage() {
  ...
  return (
    <>
      ...
      />
    <div className="p-4 max-w-md mx-auto bg-[#F1F6FD] min-h-screen pb-24 pt-8">
        ...
        <>
          ...
          <div className="space-y-3 mb-6">
            {selectedProducts.length === 0 ? (
              <p className="text-center text-gray-500 py-4 bg-white rounded-xl">
                Belum ada barang ditambahkan.
              </p>
            ) : (
              selectedProducts.map((item) => (
                <div key={item.product.id} className="bg-white rounded-xl flex items-center p-3 relative">
                  <button
      ...
      <div className="bg-white rounded-xl p-4 space-y-2 mb-6">
        <div className="flex justify-between items-center">
          <span className="text-[#818898]">Total {transactionMode === "pemasukan" ? "Pemasukan" : "Pengeluaran"}</span>
        ...
        {transactionMode === "pemasukan" && categoryType === "Penjualan Barang" && (
          <div className="flex justify-between items-center">
            <span className="text-[#818898]">Modal</span>
            <div className="flex items-center border rounded px-2 focus-within:border-blue-500">
              <span className="text-gray-500 text-sm mr-1">Rp</span>
              <input
                type="text"
        ...
        <div className="flex justify-between items-center">
          <span className="text-[#818898]">Status</span>
